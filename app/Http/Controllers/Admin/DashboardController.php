...
class DashboardController extends Controller
{
    ...
    public function updateProfile(Request $request)
    {
        ...
        $request->validate([
            ...
            'hero_bg_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:102400'],
    ...
    public function updateBiography(Request $request)
    {
        ...
        $request->validate([
            ...
            'photo' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:102400'],
            'workspace_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:102400'],
            'tech_image' => ['nullable', 'image', 'mimes:jpeg,png,jpg,gif,webp', 'max:102400'],
            'bio_backgrounds' => ['nullable', 'array'],
            'bio_backgrounds.*' => ['image', 'mimes:jpeg,png,jpg,gif,webp', 'max:102400'],
